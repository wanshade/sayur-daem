...
export const features = [
  {
    ...
    description: "Belanjaan nyampe kurang dari 30 menit, secepet kilat!",
  },
  {
    icon: leaf_icon,
    title: "Selalu Segar",
    description: "Langsung dari sumbernya. sayur, buah, & bahan segar.",
  },
  {
    icon: coin_icon,
    title: "Harga Bersahabat",
    description: "Kualitas juara, harga tetep hemat. Gak bikin kantong jebol!",
  },
  {
    icon: trust_icon,
    title: "Dipercaya Ribuan Orang",
    description: "Lebih dari 10.000 pelanggan puas bareng kami tiap harinya.",
  },
];
